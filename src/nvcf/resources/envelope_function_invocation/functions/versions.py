...
from ....types.envelope_function_invocation.functions import version_invoke_params
...
class VersionsResource(SyncAPIResource):
    ...
    def invoke(
        ...
        *,
        function_id: str,
        request_body: object,
        request_header: version_invoke_params.RequestHeader | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            f"/v2/nvcf/exec/functions/{function_id}/versions/{version_id}",
            body=maybe_transform(
                {
                    "request_body": request_body,
                    "request_header": request_header,
                },
                version_invoke_params.VersionInvokeParams,
            ),
