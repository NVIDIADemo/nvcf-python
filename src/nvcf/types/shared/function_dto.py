...
__all__ = ["FunctionDTO", "ActiveInstance", "ContainerEnvironment", "Model", "Resource"]
...
class FunctionDTO(BaseModel):
    ...
    active_instances: Optional[List[ActiveInstance]] = FieldInfo(alias="activeInstances", default=None)
    ...
    container_environment: Optional[List[ContainerEnvironment]] = FieldInfo(alias="containerEnvironment", default=None)
    ...
    health: Optional[HealthDTO] = None
