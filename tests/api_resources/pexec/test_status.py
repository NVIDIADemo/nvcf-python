...
class TestStatus:
    ...
    @parametrize
    def test_method_retrieve_with_all_params(self, client: NvidiaCloudFunctions) -> None:
        status = client.pexec.status.retrieve(
            request_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            nvcf_poll_seconds=0,
        )
...
class TestAsyncStatus:
    ...
    @parametrize
    async def test_method_retrieve_with_all_params(self, async_client: AsyncNvidiaCloudFunctions) -> None:
        status = await async_client.pexec.status.retrieve(
            request_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            nvcf_poll_seconds=0,
        )
