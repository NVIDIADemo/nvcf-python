...
class TestVersions:
    ...
    def test_method_retrieve_all(self, client: NVCF) -> None:
        version = client.nvcf.functions.versions.retrieve_all(
    ...
    def test_raw_response_retrieve_all(self, client: NVCF) -> None:
        response = client.nvcf.functions.versions.with_raw_response.retrieve_all(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve_all(self, client: NVCF) -> None:
        with client.nvcf.functions.versions.with_streaming_response.retrieve_all(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_all(self, client: NVCF) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `function_id` but received ''"):
            client.nvcf.functions.versions.with_raw_response.retrieve_all(
                "",
            )
...
class TestAsyncVersions:
    ...
    async def test_method_retrieve_all(self, async_client: AsyncNVCF) -> None:
        version = await async_client.nvcf.functions.versions.retrieve_all(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(FunctionsResponse, version, path=["response"])
    ...
    async def test_raw_response_retrieve_all(self, async_client: AsyncNVCF) -> None:
        response = await async_client.nvcf.functions.versions.with_raw_response.retrieve_all(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve_all(self, async_client: AsyncNVCF) -> None:
        async with async_client.nvcf.functions.versions.with_streaming_response.retrieve_all(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_all(self, async_client: AsyncNVCF) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `function_id` but received ''"):
            await async_client.nvcf.functions.versions.with_raw_response.retrieve_all(
                "",
            )
