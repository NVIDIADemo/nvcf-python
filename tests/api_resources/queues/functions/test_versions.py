...
from nvcf.types.shared import GetQueuesResponse
...
class TestVersions:
    ...
    def test_method_list(self, client: NVCF) -> None:
        version = client.queues.functions.versions.list(
            version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            function_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(GetQueuesResponse, version, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: NVCF) -> None:
        response = client.queues.functions.versions.with_raw_response.list(
            version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            function_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: NVCF) -> None:
        with client.queues.functions.versions.with_streaming_response.list(
            version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            function_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_list(self, client: NVCF) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `function_id` but received ''"):
            client.queues.functions.versions.with_raw_response.list(
                version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                function_id="",
            )
...
class TestAsyncVersions:
    ...
    async def test_method_list(self, async_client: AsyncNVCF) -> None:
        version = await async_client.queues.functions.versions.list(
            version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            function_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(GetQueuesResponse, version, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncNVCF) -> None:
        response = await async_client.queues.functions.versions.with_raw_response.list(
            version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            function_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncNVCF) -> None:
        async with async_client.queues.functions.versions.with_streaming_response.list(
            version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            function_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncNVCF) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `function_id` but received ''"):
            await async_client.queues.functions.versions.with_raw_response.list(
                version_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                function_id="",
            )
